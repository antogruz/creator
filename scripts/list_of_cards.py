def get_all():
    ...
    cards += ["Léonidas","Laboratoire","Loge"]
    cards += ["Mécène","Métier à tisser","Maison de jeu","Marché", "Marché noir", "Marché aux esclaves", "Mercenaires","Midas","Milice","Mine","Muraille"]
    cards += ["Néfertiti","Néron","Nabuchodonosor"]
    cards += ["Observatoire","Officine"]
    cards += ["Périclès","Palace","Palissade","Panthéon","Phare","Phidias","Pigeonnier","Place d'armes","Planque","Platon","Port","Portes de la ville","Praxitèle","Presse", "Prêteur sur gages", "Ptolémée","Pythagore"]
